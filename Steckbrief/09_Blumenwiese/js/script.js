...
(function (Blumenwiese) {
    ...
    //
    function update() {
        Blumenwiese.crc2.fillStyle = "#4c6273";
        Blumenwiese.crc2.fillRect(0, 0, window.innerWidth, window.innerHeight);
        for (var i = 0; i < 10; i++) {
        ...
        for (let i = 0; i < beeArray.length; i++) {
            beeArray[i].draw(0.4, 0.4);
            beeArray[i].move(1 / 10);
        }
        drawMoon(window.innerWidth * 0.1, window.innerHeight * 0.1, 30, "rgb(255, 192, 92)", "rgb(255, 215, 105, 0.5)");
        for (let i = 0; i < 20; i++) {
    ...
    function createBee() {
        for (let i = 0; i < 10; i++) {
            ...
            let beePosition = new Blumenwiese.Vector(randomXBee, randomYBee);
            let velocityBee = new Blumenwiese.Vector(-70, 0);
            let bee = new Blumenwiese.Bee(beePosition, velocityBee);
            bee.draw(0.4, 0.4);
            bee.move(1 / 50);
            beeArray.push(bee);
        }
    ...
    function createTulip() {
        for (let i = 0; i < 10; i++) {
            ...
            let flowerPosition2 = new Blumenwiese.Vector(randomXOnGrass, randomYOnGrass);
            let tulip = new Blumenwiese.Tulip(flowerPosition2, "pink", "#355233");
            tulip.draw();
    ...
    function createFlower() {
        for (let i = 0; i < 10; i++) {
            let randomXOnGrass = Math.random() * window.innerWidth;
            let randomYOnGrass = Math.random() * (window.innerHeight * 0.6 - window.innerHeight) + window.innerHeight;
            let flowerPosition = new Blumenwiese.Vector(randomXOnGrass, randomYOnGrass);
            let flowerLeft = new Blumenwiese.Flower(flowerPosition, 10, "#355233", "orange", 90);
            flowerLeft.draw();
        ...
        for (let i = 0; i < 10; i++) {
            ...
            let randomYOnGrass = Math.random() * (window.innerHeight * 0.6 - window.innerHeight) + window.innerHeight;
            let flowerPosition = new Blumenwiese.Vector(randomXOnGrass, randomYOnGrass);
            let flowerRight = new Blumenwiese.Flower(flowerPosition, -10, "#355233", "#ffe357", 90);
            flowerRight.draw();
    ...
    function createCloud() {
        ...
        let cloud1Position = new Blumenwiese.Vector(randomXClouds1, randomYClouds1);
        let cloud1Position2 = new Blumenwiese.Vector(randomXClouds2, randomYClouds2);
        let cloudSize = new Blumenwiese.Vector(250, 70);
        let velocityClouds1 = new Blumenwiese.Vector(10, 0);
        let velocityClouds2 = new Blumenwiese.Vector(-20, 0);
        for (let i = 0; i < 20; i++) {
            let cloud1 = new Blumenwiese.Cloud(cloud1Position, cloudSize, velocityClouds1, xCloudArray[i], yCloudArray[i]);
            let cloud2 = new Blumenwiese.Cloud(cloud1Position2, cloudSize, velocityClouds2, xCloudArray[i], yCloudArray[i]);
            cloud1.draw();
            cloud2.draw();
            console.log("gemalt");
    ...
    function drawGrass(_horizon, _color1, _color2, _color3) {
        ...
        Blumenwiese.crc2.moveTo(0, _horizon);
        Blumenwiese.crc2.lineTo(window.innerWidth, _horizon);
        Blumenwiese.crc2.lineTo(window.innerWidth, window.innerHeight);
        Blumenwiese.crc2.lineTo(0, window.innerHeight);
        Blumenwiese.crc2.lineTo(0, _horizon);
        Blumenwiese.crc2.strokeStyle = "rgba(1, 1, 1, 0)";
        let gradient = Blumenwiese.crc2.createLinearGradient(0, 0, 0, Blumenwiese.crc2.canvas.height);
    ...
    function drawMountians(_horizon, _height, _heightMax, _colorLow, _colorHigh) {
        ...
        Blumenwiese.crc2.beginPath();
        Blumenwiese.crc2.moveTo(0, _horizon);
        Blumenwiese.crc2.lineTo(0, _height);
        Blumenwiese.crc2.translate(0, _height);
        for (let i = 0; i < stepArray.length; i++) {
            Blumenwiese.crc2.lineTo(stepArray[i], heightArray[i]);
        }
        Blumenwiese.crc2.lineTo(window.innerWidth, _horizon);
        Blumenwiese.crc2.closePath();
        let gradient = Blumenwiese.crc2.createLinearGradient(0, 0, 0, -_heightMax);
    ...
    function drawMoon(_X, _Y, _radius, _color1, _color2) {
        let gradient = Blumenwiese.crc2.createRadialGradient(0, 0, 0, 0, 0, 30);
        Blumenwiese.crc2.save();
        Blumenwiese.crc2.beginPath();
        Blumenwiese.crc2.moveTo(_X, _Y);
        Blumenwiese.crc2.translate(_X, _Y);
        Blumenwiese.crc2.arc(0, 0, _radius, 0, 2 * Math.PI);
        gradient.addColorStop(0, _color1);
    ...
    function createStarPosition() {
        for (let i = 0; i < 10; i++) {
            ...
            starArray.push(new Blumenwiese.Vector(randomX, randomY));
        }
    }
    function drawStar(_cx, cy, spikes, outerRadius, innerRadius) {
        ...
        Blumenwiese.crc2.save();
        Blumenwiese.crc2.beginPath();
        Blumenwiese.crc2.moveTo(_cx, cy - outerRadius);
        ...
        Blumenwiese.crc2.lineTo(_cx, cy - outerRadius);
        Blumenwiese.crc2.closePath();
        Blumenwiese.crc2.lineWidth = 5;
        Blumenwiese.crc2.strokeStyle = "rgba(1, 1, 1, 0)";
        Blumenwiese.crc2.stroke();
        Blumenwiese.crc2.fillStyle = "#f5f4cb";
        Blumenwiese.crc2.fill();
        Blumenwiese.crc2.restore();
    }
    function drawBeeStock() {
        Blumenwiese.crc2.save();
        Blumenwiese.crc2.beginPath();
        Blumenwiese.crc2.moveTo(window.innerWidth * 0.8, window.innerHeight * 0.8);
        Blumenwiese.crc2.translate(window.innerWidth * 0.8, window.innerHeight * 0.8);
        Blumenwiese.crc2.ellipse(0, 0, 15, 30, 300, 0, 2 * Math.PI);
        Blumenwiese.crc2.stroke();
        Blumenwiese.crc2.ellipse(0, 10, 15, 35, 300, 0, 2 * Math.PI);
        Blumenwiese.crc2.stroke();
        Blumenwiese.crc2.ellipse(0, 20, 15, 40, 300, 0, 2 * Math.PI);
        Blumenwiese.crc2.stroke();
        Blumenwiese.crc2.ellipse(0, 30, 15, 44, 300, 0, 2 * Math.PI);
        Blumenwiese.crc2.stroke();
        ...
        let gradient = Blumenwiese.crc2.createLinearGradient(0, 0, 15, 0);
